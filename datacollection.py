...
# Create a folder to store the collected face data
...
# Create the subdirectory by joining the parent directory path and subdirectory name
...
# Set a counter for the number of faces collected
counter = 1
while True:
